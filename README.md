...
local ui = game.CoreGui:FindFirstChild("Discord")
if ui then
    ui:Destroy()
end
wait()
...
Discord.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    local Discordui = game.CoreGui:FindFirstChild("Discord")
	...
	function ServerHold:Server(text, img)
        ...
        ServerIco.Position = UDim2.new(0, 25, 0, 25)
        ServerIco.Size = UDim2.new(0, 55, 0, 60)
        ServerIco.Image = "http://www.roblox.com/asset/?id=7189574443"
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Icon.Image = "http://www.roblox.com/asset/?id=7189574443"
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				ArrowImg.Image = "http://www.roblox.com/asset/?id=7189574443"
